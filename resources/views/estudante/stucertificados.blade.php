                                    ...
                                    @foreach($allUserInfo as $stu)
                                        @if($stu->contacto == "Ciências Naturas (Opção B)")
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm" id="view" target="" href="{{ route('viewStuCert', $stu->nomeCompleto)}}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-primary btn-sm" id="download" target="" href=""><i class="fa fa-fw fa-download"></i></a>
                                                </td>
                                            </td>
                                        @else
                                            <tr>
