...
<body>
    <div class="container">
        ...
        <div style="margin-top:8px;text-align:center;">
            SERVICO DE EDUCACAO, JUVENTUDE E TECNOLOGIA
        </div>
        <div style="margin-top:8px;text-align:center;">
    ...
    @foreach($certificado as $certificado)
        @if($certificado->contacto == "Ciências Naturas (Opção B)")
            ...
            <p>Os resultados constam da pauta nº 999 e do livro de Termo de Exames nº 999/2022, júri {{$certificado->juri}}, nº do aluno {{$certificado->id}}.<br>
