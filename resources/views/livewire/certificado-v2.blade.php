            ...
            @foreach ($certificados as $certificado)
               @if($certificado->situacao == "Aprovado")
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary " href="{{ route('createStuCert',$certificado->id) }}'"><i class="fa fa-fw fa-eye"></i></a>
                        </td>
                    </tr>
               @endif
            @endforeach
                            ...
                            success: function(certificados)
                            {
                                    ...
                                    if(certificados[i].contacto == "Ciências Naturas (Opção B)")
                                {
                                    ...
                                    '<tr>\
                                        ...
                                        <td>\
                                            <a class="btn btn-sm btn-primary" href="/office/certificados/viewpdf/'+certificados[i].id+'"><i class="fa fa-fw fa-eye"></i></a>\
                                        </td>\
                                    </tr>'
                                    );
                                }else
